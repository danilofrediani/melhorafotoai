  ...
  useEffect(() => {
    const handlePasswordRecovery = async () => {
      try {
        ...
        if (hasCode && hasState && !hasTypeRecovery) {
        ...
        // 3) Último fallback: talvez o listener já criou a sessão
        ...
        // Se chegou aqui, link não é válido para recovery
        ...
        setError(e?.message || 'O link de recuperação é inválido ou expirou.');
        setPageState('error');
      }
    };
